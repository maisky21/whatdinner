...
const MENU_DATA = [
    ...
    { 
        ...
        fortune: '부드러운 크림의 풍미가 입안을 감싸듯, 오늘 당신의 하루는 평온하고 아늑한 기운으로 가득 찰 것입니다. 복잡한 생각은 잠시 접어두고 현재의 소소한 행복에 집중해보세요. 예술적 감수성이 높아져 새로운 아이디어가 샘솟는 날입니다.', 
        fortune_en: 'As the smooth cream flavor envelops your mouth, your day will be filled with peaceful and cozy energy. Put aside complex thoughts and focus on small current happiness. Your artistic sensitivity is high today.', 
    ...
    { 
        ...
        fortune: '여러 조각의 피자가 모여 하나의 완벽한 원을 이루듯, 흩어져 있던 계획들이 하나로 뭉쳐 성과를 내기 시작합니다. 예상치 못한 곳에서 협력자가 나타나 당신의 짐을 나누어 들어줄 운세입니다. 나눔을 실천할 때 행운이 배가됩니다.', 
        fortune_en: 'As pieces of pizza form a perfect circle, scattered plans will unite to yield results. A collaborator will appear unexpectedly to share your burden. Luck doubles when you practice sharing.', 
    ...
    { 
        ...
        fortune: '든든한 고기 한 점이 주는 묵직한 존재감처럼 오늘 당신은 어디서나 자신감 넘치는 태도로 주목받게 됩니다. 리더십을 발휘하기에 최적의 시기이며, 중요한 결정을 내려야 한다면 지금이 적기입니다. 당신의 내면의 힘을 믿으세요.', 
        fortune_en: 'Like the heavy presence of a hearty piece of meat, you will be noticed everywhere for your confident attitude. It\'s the perfect time to exercise leadership and make important decisions. Trust your inner strength.', 
    ...
    { 
        ...
        fortune: '꽉 찬 패티와 신선한 야채의 조화처럼 오늘 당신은 실속 있는 성취감을 맛보게 됩니다. 겉치레보다는 본질에 집중했을 때 결과가 더 빛을 발하는 하루입니다. 바쁜 와중에도 자신을 위한 작은 보상을 잊지 마세요.', 
        fortune_en: 'Like the harmony of a full patty and fresh vegetables, you will experience a substantial sense of achievement today. Results will shine more when you focus on the essence. Don\'t forget a small reward for yourself.', 
    ...
    { 
        ...
        fortune: '쌀알 하나하나에 풍미가 깊게 스며들듯, 당신의 꾸준한 노력이 드디어 주위에 깊은 인상을 남기기 시작합니다. 서두르지 않고 정성을 다한 일들이 인정을 받게 되니, 마지막까지 끈기를 잃지 마세요. 바다처럼 넓은 포용력이 필요한 때입니다.', 
        fortune_en: 'As flavor seeps deep into every grain of rice, your steady efforts are finally starting to leave a deep impression. Things done with sincerity will be recognized, so don\'t lose patience until the end.', 
    ...
    { 
        ...
        fortune: '초밥의 정갈함과 깔끔함처럼 복잡하게 얽혀 있던 생각들이 명확하게 정리되는 날입니다. 불필요한 것들을 덜어내고 본질에 집중할 때 비로소 최고의 컨디션을 유지할 수 있습니다. 오늘은 담백한 태도가 행운을 불러옵니다.', 
        fortune_en: 'Like the neatness of sushi, complex thoughts will be clearly organized today. You can maintain your best condition by removing unnecessary things and focusing on the essence. A simple attitude brings luck.', 
    ...
    { 
        ...
        fortune: '깊고 진한 국물 맛처럼 당신의 인간관계가 한층 더 깊어지는 소중한 시간을 갖게 됩니다. 겉도는 대화보다는 진심을 담은 이야기가 상대방의 마음을 움직일 거예요. 오늘 밤은 따뜻한 온기 속에서 위로와 치유를 얻는 운세입니다.', 
        fortune_en: 'Like the deep broth, you will have precious time to deepen your relationships. Heartfelt stories rather than superficial talk will move people. A fortune of obtaining comfort and healing in warmth tonight.', 
    ...
    { 
        ...
        fortune: '바삭한 튀김옷 안에 부드러운 고기가 숨어있듯, 당신의 부드러운 외유내강형 매력이 빛을 발하는 날입니다. 겉으로는 평온해 보이지만 내면의 단단한 의지가 불가능해 보였던 일을 가능하게 만들 것입니다. 승리운이 따르는 하루입니다.', 
        fortune_en: 'Just as tender meat is hidden inside a crispy coating, your soft-on-the-outside, tough-on-the-inside charm shines. Your firm inner will will make the impossible possible. Victory luck follows you.', 
    ...
    { 
        ...
        fortune: '시원한 메밀면이 막힌 곳을 뚫어주듯, 오늘 당신의 정체되었던 운 흐름이 활발해지기 시작합니다. 답답했던 문제들에 대한 해결책이 떠오르거나, 새로운 관점에서 세상을 보게 될 거예요. 몸과 마음을 가볍게 유지하는 것이 핵심입니다.', 
        fortune_en: 'As cool buckwheat noodles clear the way, your stagnant fortune will start to flow actively. Solutions to frustrating problems will emerge, or you\'ll see the world from a new perspective. Keep your body and mind light.', 
    ...
    { 
        ...
        fortune: '오동통한 우동 면발처럼 당신의 일상이 풍성하고 탄력 있게 흘러갈 징조입니다. 따뜻한 배려심이 당신의 주변을 훈훈하게 만들며, 그 친절이 더 큰 행운으로 돌아오게 됩니다. 마음의 여유를 갖고 느긋하게 하루를 즐기세요.', 
        fortune_en: 'Your daily life will flow richly and resiliently like plump udon noodles. Warm consideration will make your surroundings pleasant, and that kindness will return as greater luck. Enjoy the day with a relaxed mind.', 
    ...
    { 
        ...
        fortune: '오늘은 익숙한 것에서 행복을 찾는 날입니다. 짜장면처럼 대중적이면서도 든든한 한 끼가 당신의 오후에 활력을 불어넣어 줄 거예요. 새로운 것을 쫓기보다는 현재 가진 소중한 인연들에 집중하면 더 좋은 기운이 깃듭니다.', 
        fortune_en: 'Today is a day to find happiness in familiar things. A meal as popular and hearty as Jajangmyeon will energize your afternoon. Focus on the precious connections you have rather than chasing new things.', 
    ...
    { 
        ...
        fortune: '짬뽕의 강렬한 불맛처럼 당신의 열정이 최고조에 달하는 운세입니다. 망설였던 일에 과감히 도전장을 내밀어보세요. 당신의 에너지가 주변 사람들을 감동시키고 주도권을 잡게 해줄 것입니다. 성공적인 변화가 시작되는 지점입니다.', 
        fortune_en: 'Your passion is reaching its peak like the intense smoky flavor of Jjamppong. Boldly take on challenges you\'ve hesitated about. Your energy will impress others and give you the lead. A point where successful change begins.', 
    ...
    { 
        ...
        fortune: '새콤달콤한 소스의 반전 매력처럼 단조롭던 일상에 신선한 변화가 찾아올 징조입니다. 고정관념을 깨는 생각 하나가 당신의 문제를 의외로 쉽게 해결해 줄 수 있습니다. 유머 감각을 잃지 않는다면 어디서나 환영받는 존재가 됩니다.', 
        fortune_en: 'Fresh change is coming to your monotonous life, like the sweet and sour sauce\'s unexpected charm. A thought that breaks stereotypes might solve your problems surprisingly easily. Humor will make you welcome anywhere.', 
    ...
    { 
        ...
        fortune: '부드러움 속에 숨겨진 알싸한 매콤함이 당신의 잠든 승부욕을 자극합니다. 겉보기엔 평범해 보이는 일도 자세히 들여다보면 큰 기회가 숨어있음을 깨닫게 될 거예요. 작지만 확실한 행운들이 모여 큰 기쁨을 만들어내는 날입니다.', 
        fortune_en: 'The hidden spiciness within softness stimulates your dormant competitive spirit. You\'ll realize that even ordinary-looking things hide great opportunities. Small but certain luck gathers to create big joy today.', 
    ...
    { 
        ...
        fortune: '작은 만두 피 속에 풍부한 육즙이 담겨있듯, 조만간 당신의 노력이 알찬 성과물로 나타날 예정입니다. 디테일에 신경을 쓴다면 완벽함에 한 걸음 더 다가갈 수 있습니다. 소중한 사람과 함께 나누는 대화가 행운의 열쇠가 됩니다.', 
        fortune_en: 'As rich juice is contained within small dumpling skins, your efforts will soon appear as substantial results. Paying attention to details will bring you closer to perfection. Conversation with loved ones is the key to luck.', 
    ...
    { 
        ...
        fortune: '가벼운 시작이 생각보다 큰 만족감을 가져다줄 수 있는 날입니다. 너무 무겁고 복잡하게 생각하기보다 기본에 충실하며 경쾌한 마음가짐을 가져보세요. 의외의 장소에서 반가운 인연을 만나거나 기분 좋은 제안을 받게 됩니다.', 
        fortune_en: 'A light start can bring more satisfaction than expected today. Instead of thinking too heavily, stick to the basics and keep a cheerful mindset. You might meet a welcome connection or receive a pleasant offer.', 
    ...
    { 
        ...
        fortune: '신선한 야채가 몸에 활력을 주듯, 오늘 당신의 정신적인 에너지가 맑아지고 건강해지는 시기입니다. 자신을 돌보고 가꾸는 시간만큼 내면의 평화가 찾아올 거예요. 명상이나 가벼운 산책이 당신의 직관력을 최고로 높여줍니다.', 
        fortune_en: 'As fresh vegetables energize the body, your mental energy is becoming clear and healthy. Inner peace will come as much as you care for yourself. Meditation or light walks will maximize your intuition.', 
    ...
    { 
        ...
        fortune: '여러 층의 재료가 조화롭게 어우러진 샌드위치처럼 당신의 다재다능함이 빛을 발할 운세입니다. 멀티태스킹 능력이 좋아져 여러 가지 일을 동시에 효율적으로 처리할 수 있습니다. 융통성 있는 태도가 문제 해결의 마스터키가 됩니다.', 
        fortune_en: 'Your versatility shines like a sandwich with harmoniously layered ingredients. Your multi-tasking ability improves, allowing you to handle various tasks efficiently. A flexible attitude is the master key to problem-solving.', 
    ...
    { 
        ...
        fortune: '단단하게 말린 김밥처럼 오늘 당신의 결심과 의지가 확고해지는 날입니다. 목표를 향해 흔들림 없이 나아간다면 조만간 원하는 지점에 도달하게 될 거예요. 간결하고 명확한 의사표현이 당신의 신뢰도를 높여주는 중요한 요소입니다.', 
        fortune_en: 'Like tightly rolled gimbap, your resolution and will become firm today. If you move toward your goal without wavering, you will soon reach your destination. Simple and clear expression is key to increasing your credibility.', 
    ...
    { 
        ...
        fortune: '고슬고슬하게 잘 볶아진 밥알처럼 오늘 당신의 일처리는 매끄럽고 완벽합니다. 기본기가 탄탄할 때 가장 위대한 결과가 나오는 법임을 명심하세요. 평소 소홀히 했던 기초적인 부분들을 점검한다면 예상치 못한 보너스 행운이 따릅니다.', 
        fortune_en: 'Your work processing is smooth and perfect like well-fried rice grains. Remember that the greatest results come when foundations are solid. Checking basic areas you\'ve neglected will bring unexpected bonus luck.', 
